...
public class Excercise16 {
    ...
    public static void main(String[] args) {
        ...
        char genra = newScan.next().charAt(0);
        System.out.print("Ingrese el peso en kilogramos: ");
        double weight = newScan.nextDouble();
        System.out.print("Ingrese la altura en metros: ");
        double height = newScan.nextDouble();
        
        Persona persona1 = new Persona(name, age, genra, weight, height);
        Persona persona2 = new Persona(name, age, genra);
        Persona persona3 = new Persona();
        
        persona3.setName(name);
        persona3.setAge(age);
        persona3.setGenra(genra);
